...
let
  sources = {
    ...
    "@bramus/specificity-2.4.2" = {
      name = "_at_bramus_slash_specificity";
      packageName = "@bramus/specificity";
      version = "2.4.2";
      src = fetchurl {
    ...
    "@cloudflare/workerd-linux-64-1.20260305.0" = {
      ...
      src = fetchurl {
        ...
        sha512 = "tt7XUoIw/cYFeGbkPkcZ6XX1aZm26Aju/4ih+DXxOosbBeGshFSrNJDBfAKKOvkjsAZymJ+WWVDBU+hmNaGfwA==";
      };
    };
    ...
    "@csstools/css-syntax-patches-for-csstree-1.1.0" = {
      ...
      version = "1.1.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/@csstools/css-syntax-patches-for-csstree/-/css-syntax-patches-for-csstree-1.1.0.tgz";
        sha512 = "H4tuz2nhWgNKLt1inYpoVCfbJbMwX/lQKp3g69rrrIMIYlFD9+zTykOKhNR8uGrAmbS/kT9n6hTFkmDkxLgeTA==";
      };
    };
    ...
    "@exodus/bytes-1.15.0" = {
      name = "_at_exodus_slash_bytes";
      packageName = "@exodus/bytes";
      version = "1.15.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/@exodus/bytes/-/bytes-1.15.0.tgz";
        sha512 = "UY0nlA+feH81UGSHv92sLEPLCeZFjXOuHhrIo0HQydScuQc8s0A7kL/UdgwgDq8g8ilksmuoF35YVTNphV2aBQ==";
      };
    };
    "@hapi/hoek-9.3.0" = {
    ...
    "canvas-3.2.1" = {
      ...
      src = fetchurl {
        ...
        sha512 = "ej1sPFR5+0YWtaVp6S1N1FVz69TQCqmrkGeRvQxZeAB1nAIcjNTHVwrZtYtWFFBmQsF40/uDLehsW5KuYC99mg==";
      };
    };
    "chai-5.3.3" = {
      name = "chai";
    ...
    "cssstyle-6.2.0" = {
      ...
      src = fetchurl {
        ...
        sha512 = "Fm5NvhYathRnXNVndkUsCCuR63DCLVVwGOOwQw782coXFi5HhkXdu289l59HlXZBawsyNccXfWRYvLzcDCdDig==";
      };
    };
    ...
    "miniflare-4.20260305.0" = {
      ...
      src = fetchurl {
        ...
        sha512 = "jVhtKJtiwaZa3rI+WgoLvSJmEazDsoUmAPYRUmEe2VO6VSbvkhbnDRm+dsPbYRatgNIExwrpqG1rv96jHiSb0w==";
      };
    };
    "minimatch-3.1.5" = {
      name = "minimatch";
  ...
  args = {
    name = "teenarazzi-backend-nix-deps";
    packageName = "teenarazzi-backend-nix-deps";
    src = ./.;
    dependencies = [
      sources."@acemir/cssom-0.9.31"
      sources."@adobe/css-tools-4.3.3"
      (sources."@asamuzakjp/css-color-5.0.1" // {
        dependencies = [
          sources."lru-cache-11.2.6"
        ];
      })
      (sources."@asamuzakjp/dom-selector-6.8.1" // {
        dependencies = [
          sources."lru-cache-11.2.6"
        ];
      })
      ...
      sources."@bramus/specificity-2.4.2"
      sources."@bufbuild/protobuf-2.11.0"
      sources."@cloudflare/workerd-linux-64-1.20260305.0"
      sources."@cspotcode/source-map-support-0.8.1"
      sources."@csstools/color-helpers-6.0.2"
      sources."@csstools/css-calc-3.1.1"
      sources."@csstools/css-color-parser-4.0.2"
      sources."@csstools/css-parser-algorithms-4.0.0"
      sources."@csstools/css-syntax-patches-for-csstree-1.1.0"
      sources."@csstools/css-tokenizer-4.0.0"
      sources."@edge-runtime/primitives-6.0.0"
      sources."@edge-runtime/vm-5.0.0"
      sources."@esbuild/linux-x64-0.27.3"
      sources."@exodus/bytes-1.15.0"
      ...
      sources."@mswjs/interceptors-0.41.3"
      sources."@noble/hashes-2.0.1"
      ...
      sources."canvas-3.2.1"
      sources."chai-5.3.3"
      sources."chalk-5.6.2"
      sources."check-error-2.1.3"
      ...
      (sources."cssstyle-6.2.0" // {
        dependencies = [
          sources."lru-cache-11.2.6"
        ];
      })
      sources."data-uri-to-buffer-6.0.2"
      sources."data-urls-7.0.0"
      ...
      sources."graphql-16.13.1"
      (sources."happy-dom-20.8.3" // {
        dependencies = [
      ...
      sources."html-encoding-sniffer-6.0.0"
      ...
      sources."miniflare-4.20260305.0"
      ...
      sources."tldts-7.0.25"
      sources."tldts-core-7.0.25"
      sources."tmpl-1.0.5"
