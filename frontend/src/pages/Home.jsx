        ...
        <>
            <div className="main-content">
                <InfoBlock img={teenarazziIcon} header="Teenarazzi" paragraph={
                    "Teenarazzi is a laid-back community for teenagers. We originally started out on Reddit as a subreddit dedicated to finding popular r/teenagers members. We always welcome new members and we hope you will check us out!"
                    } component={() => <PageButton header="Click here to learn more!" to="/about" />} />
