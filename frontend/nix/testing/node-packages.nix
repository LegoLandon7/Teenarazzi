...
let
  ...
  args = {
    name = "teenarazzi-frontend-test-deps";
    packageName = "teenarazzi-frontend-test-deps";
    src = ./.;
    dependencies = [
      sources."@acemir/cssom-0.9.31"
      sources."@adobe/css-tools-4.4.4"
      ...
      (sources."@testing-library/jest-dom-6.9.1" // {
        dependencies = [
          sources."dom-accessibility-api-0.6.3"
        ];
      })
      sources."@testing-library/react-16.3.2"
